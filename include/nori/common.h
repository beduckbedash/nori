...
/*
void reflect(const Vector3f& wi, const Vector3f& n, Vector3f* wo)
{
    *wo = -wi + 2 * (wi.dot(n)) * n;
}

bool refract(const Vector3f& wo, const Vector3f& n, Vector3f* wt, float eta)
{
    float cosThetaI = wo.dot(n);
